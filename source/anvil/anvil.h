...
ANVIL__list COMP__open__list_with_error(ANVIL__list_increase list_increase, COMP__error* error) {
    // open with error
    return ANVIL__open__list(list_increase, &((*error).memory_error_occured));
}

// append a buffer but the error is compiler
void COMP__append__buffer_with_error(ANVIL__list* list, ANVIL__buffer buffer, COMP__error* error) {
...
typedef enum STD__sot {
    // offsets
    STD__sot__package_start,

    // translation functions
    STD__sot__calculate_decimal_digit_count__start,
    STD__sot__calculate_decimal_digit_count__loop_start,
    STD__sot__calculate_decimal_digit_count__return,
    STD__sot__cell_to_unsigned_integer_string__start,
    STD__sot__cell_to_unsigned_integer_string__loop_start,
    STD__sot__cell_to_unsigned_integer_string__return,

    // printing functions
    STD__sot__print_binary__start,
    STD__sot__print_buffer_as_string__start,
    STD__sot__print_buffer_as_string__loop__start,
    STD__sot__print_buffer_as_string__loop__end,
...
typedef struct STD__offsets {
    ANVIL__offset offsets[STD__sot__COUNT];
} STD__offsets;
...
void STD__code__call__calculate_decimal_digit_count(ANVIL__workspace* workspace, STD__offsets* std_offsets, ANVIL__flag_ID flag, ANVIL__cell_ID input__value, ANVIL__cell_ID output__digit_count) {
	...
	// call function
	ANVIL__code__call__static(workspace, flag, (*std_offsets).offsets[STD__sot__calculate_decimal_digit_count__start]);
...
void STD__code__calculate_decimal_digit_count(ANVIL__workspace* workspace, STD__offsets* std_offsets) {
	...
	(*std_offsets).offsets[STD__sot__calculate_decimal_digit_count__start] = ANVIL__get__offset(workspace);
    ...
    ANVIL__code__operate__jump__static(workspace, ANVIL__sft__always_run, STD__calculate_decimal_digit_count__zero, STD__calculate_decimal_digit_count__value, STD__calculate_decimal_digit_count__zero, ANVIL__sft__never_run, (*std_offsets).offsets[STD__sot__calculate_decimal_digit_count__return]);
	...
	// setup loop start
	(*std_offsets).offsets[STD__sot__calculate_decimal_digit_count__loop_start] = ANVIL__get__offset(workspace);
    ...
    // jump to beginning
    ANVIL__code__jump__static(workspace, ANVIL__sft__always_run, (*std_offsets).offsets[STD__sot__calculate_decimal_digit_count__loop_start]);

	// setup loop return
	(*std_offsets).offsets[STD__sot__calculate_decimal_digit_count__return] = ANVIL__get__offset(workspace);
...
void STD__code__call__cell_to_unsigned_integer_string(ANVIL__workspace* workspace, STD__offsets* std_offsets, ANVIL__flag_ID flag, ANVIL__cell_ID input__value, ANVIL__cell_ID output__number_start, ANVIL__cell_ID output__number_end) {
	...
	// call function
	ANVIL__code__call__static(workspace, flag, (*std_offsets).offsets[STD__sot__cell_to_unsigned_integer_string__start]);
...
void STD__code__cell_to_unsigned_integer_string(ANVIL__workspace* workspace, STD__offsets* std_offsets) {
	// setup function offset
	(*std_offsets).offsets[STD__sot__cell_to_unsigned_integer_string__start] = ANVIL__get__offset(workspace);
	...
	ANVIL__code__jump__static(workspace, ANVIL__sft__always_run, std_offsets->offsets[STD__sot__cell_to_unsigned_integer_string__loop_start]);

	// setup return
	std_offsets->offsets[STD__sot__cell_to_unsigned_integer_string__return] = ANVIL__get__offset(workspace);
...
void STD__code__call__print_binary(ANVIL__workspace* workspace, STD__offsets* standard_offsets, ANVIL__flag_ID flag, ANVIL__cell_ID input__value) {
	...
	// call function
	ANVIL__code__call__static(workspace, flag, (*standard_offsets).offsets[STD__sot__print_binary__start]);
...
void STD__code__print_binary(ANVIL__workspace* workspace, STD__offsets* standard_offsets) {
	// setup function offset
	(*standard_offsets).offsets[STD__sot__print_binary__start] = ANVIL__get__offset(workspace);
...
void STD__code__call__print_buffer_as_string(ANVIL__workspace* workspace, STD__offsets* std_offsets, ANVIL__flag_ID flag, ANVIL__cell_ID input__buffer_start, ANVIL__cell_ID input__buffer_end) {
	...
	// call function
	ANVIL__code__call__static(workspace, flag, (*std_offsets).offsets[STD__sot__print_buffer_as_string__start]);
...
void STD__code__print_buffer_as_string(ANVIL__workspace* workspace, STD__offsets* std_offsets) {
	// setup function offset
	(*std_offsets).offsets[STD__sot__print_buffer_as_string__start] = ANVIL__get__offset(workspace);
    ...
    // setup loop start offset
	(*std_offsets).offsets[STD__sot__print_buffer_as_string__loop__start] = ANVIL__get__offset(workspace);
    ...
    ANVIL__code__operate__jump__static(workspace, ANVIL__sft__always_run, STD__print_buffer_as_string__buffer_start, STD__print_buffer_as_string__current, STD__print_buffer_as_string__buffer_end, ANVIL__sft__always_run, (*std_offsets).offsets[STD__sot__print_buffer_as_string__loop__end]);
    ...
    ANVIL__code__jump__static(workspace, ANVIL__sft__always_run, (*std_offsets).offsets[STD__sot__print_buffer_as_string__loop__start]);

    // setup loop end offset
	(*std_offsets).offsets[STD__sot__print_buffer_as_string__loop__end] = ANVIL__get__offset(workspace);
...
COMP__lexlings COMP__compile__lex(ANVIL__buffer user_code, COMP__file_index file_index, COMP__error* error) {
    ...
    // setup output
    output.data = COMP__open__list_with_error(sizeof(COMP__lexling) * 64, error);
...
ANVIL__list COMP__parse__arguments(COMP__current* current, COMP__io_count* count, ANVIL__bt is_header, COMP__error* error) {
    ...
    *count = 0;
    ...
    // open names list
    output = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 8, error);
...
COMP__parsling_abstraction COMP__parse__abstraction(COMP__current* current, COMP__error* error) {
    ...
    output.statements = COMP__open__list_with_error(sizeof(COMP__parsling_statement) * 16, error);
...
COMP__parsling_program COMP__parse__program(COMP__lexlings lexlings, COMP__error* error) {
    ...
    output.abstractions = COMP__open__list_with_error(sizeof(COMP__parsling_abstraction) * 64, error);
...
ANVIL__list COMP__generate__call_blueprint(ANVIL__list parsling_programs, COMP__error* error) {
    ...
    // open output
    ANVIL__list output = COMP__open__list_with_error(sizeof(COMP__accountling_abstraction_header) * 256, error);
    if (COMP__check__error_occured(error)) {
        return output;
    }
    ...
    while (COMP__check__current_within_range(current_blueprintling) && (*(COMP__blueprintling*)current_blueprintling.start) == COMP__abt__define_call) {
        ...
        // open inputs
        header.header.inputs = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 8, error);
        ...
        // open outputs
        header.header.outputs = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 8, error);
...
ANVIL__list COMP__account__accountling_argument_list(COMP__accountling_abstraction* abstraction, ANVIL__list parsling_arguments, COMP__error* error) {
    // open list
    ANVIL__list output = COMP__open__list_with_error(sizeof(COMP__accountling_argument) * 16, error);
    if (COMP__check__error_occured(error)) {
        return output;
    }
...
COMP__accountling_abstraction COMP__account__abstraction(ANVIL__list call_blueprint, ANVIL__list* predefined_variables, ANVIL__list* predefined_flags, COMP__parsling_abstraction parsling_abstraction, COMP__error* error) {
    ...
    // validate that all variables are not used before declared
    {
        ...
        {
            // open inputs
            output.inputs = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 16, error);
            if (COMP__check__error_occured(error)) {
                return output;
            }
        ...
        {
            // open outputs
            output.outputs = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 16, error);
            if (COMP__check__error_occured(error)) {
                return output;
            }
        ...
        {
            // open doubles
            output.doubles = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 16, error);
            if (COMP__check__error_occured(error)) {
                return output;
            }
        ...
        {
            // open variables
            output.variables = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 16, error);
            if (COMP__check__error_occured(error)) {
                return output;
            }
    ...
    {
        // open list
        output.offsets = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 16, error);
        if (COMP__check__error_occured(error)) {
            return output;
        }
    ...
    // get flags
    {
        ...
        // open list
        output.flags = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 16, error);
        if (COMP__check__error_occured(error)) {
            return output;
        }
    ...
    {
        // open strings
        output.strings = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 16, error);
        if (COMP__check__error_occured(error)) {
            return output;
        }
        output.converted_strings = COMP__open__list_with_error(sizeof(ANVIL__buffer) * 16, error);
        if (COMP__check__error_occured(error)) {
            return output;
        }
            ...
            if (statement.type == COMP__st__abstraction_call) {
                ...
                while (COMP__check__current_within_range(current_input)) {
                    ...
                    if (input->type == COMP__pat__literal__string) {
                        ...
                        COMP__append__buffer_with_error(&output.converted_strings, COMP__account__convert_string(*input, error), error);
                        if (COMP__check__error_occured(error)) {
                            return output;
                        }
                    }
    ...
    {
        // open list
        output.statements = COMP__open__list_with_error(sizeof(COMP__accountling_statement) * 16, error);
        if (COMP__check__error_occured(error)) {
            return output;
        }
...
ANVIL__list COMP__generate__predefined_variables(COMP__error* error) {
    ...
    // open output
    output = COMP__open__list_with_error(sizeof(COMP__parsling_argument) * 16, error);
    if (COMP__check__error_occured(error)) {
        return output;
    }
...
COMP__accountling_program COMP__account__program(ANVIL__list parsling_programs, COMP__error* error) {
    ...
    output.abstractions = COMP__open__list_with_error(sizeof(COMP__accountling_abstraction) * 16, error);
    if (COMP__check__error_occured(error)) {
        goto quit;
    }
...
COMP__generation_abstraction COMP__open__generation_abstraction(COMP__accountling_abstraction accountlings, COMP__error* error) {
    ...
    output.offsets.statement_offsets = COMP__open__list_with_error(sizeof(ANVIL__offset) * 16, error);
    output.offsets.strings_offsets = COMP__open__list_with_error(sizeof(ANVIL__offset) * 16, error);
...
void COMP__open__generation_workspace(ANVIL__buffer* program_buffer, COMP__accountling_program accountlings, COMP__generation_workspace* output, COMP__error* error) {
    ...
    output->abstractions = COMP__open__list_with_error(sizeof(COMP__generation_abstraction) * 16, error);
...
void COMP__compile__files(ANVIL__buffer user_codes, ANVIL__bt print_debug, ANVIL__buffer* final_program, COMP__error* error) {
    ...
    *error = COMP__create_null__error();
    ...
    compilation_unit.lexling_buffers = COMP__open__list_with_error(sizeof(COMP__lexlings) * 5, error);
    compilation_unit.parsling_buffers = COMP__open__list_with_error(sizeof(COMP__parsling_program) * 5, error);
