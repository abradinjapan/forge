...
#define ANVIL__define__run_forever (u64)-1
...
// instruction type and instruction ID defines
// instruction type (type number is also ID)
...
typedef enum ANVIL__ilt {
    ...
    ANVIL__ilt__address_to_register = sizeof(ANVIL__instruction_ID) + (sizeof(ANVIL__register_ID) * 3),
    ANVIL__ilt__register_to_address = sizeof(ANVIL__instruction_ID) + (sizeof(ANVIL__register_ID) * 3),
    ...
    ANVIL__ilt__debug__mark_code_section = sizeof(ANVIL__instruction_ID),
} ANVIL__ilt;
...
ANVIL__nit ANVIL__run__operation(ANVIL__context* context, ANVIL__ot operation_type, ANVIL__register_ID input_0, ANVIL__register_ID input_1, ANVIL__register_ID input_2, ANVIL__register_ID output_0) {
    ...
    case ANVIL__ot__flag_xor: // untested!
        ...
        break;
    // flag get
    case ANVIL__ot__flag_get: // untested!
        // get data
        ...
        break;
    // flag set
    case ANVIL__ot__flag_set: // untested!
        // get data
        temp_input_0 = (ANVIL__register_integer_value)ANVIL__get__register_from_context(context, input_0); // flag value
        temp_result = (ANVIL__register_integer_value)ANVIL__get__register_from_context(context, output_0); // destination

        // set flag
        ANVIL__set__flag_in_context(context, temp_result, (ANVIL__bt)temp_input_0);
...
ANVIL__nit ANVIL__run__instruction(ANVIL__context* context) {
    ...
    case ANVIL__it__operate:
        ...
        // DEBUG
        // printf("Operation: %lu? [%lu] -> (%lu, %lu, %lu)(%lu)", (ANVIL__u64)operate__flag_ID, (ANVIL__u64)operate__operation_ID, (ANVIL__u64)operate__input_register_ID_0, (ANVIL__u64)operate__input_register_ID_1, (ANVIL__u64)operate__input_register_ID_2, (ANVIL__u64)operate__output_register_ID_0);
    ...
    case ANVIL__it__debug__mark_code_section:
        // instruction does nothing but mark the start of code space
        break;
...
void ANVIL__code__address_to_register(ANVIL__workspace* workspace, ANVIL__register_ID source_address, ANVIL__register_ID bit_count, ANVIL__register_ID destination_register) {
    // write instruction
...
void ANVIL__code__register_to_address(ANVIL__workspace* workspace, ANVIL__register_ID source_register, ANVIL__register_ID bit_count, ANVIL__register_ID destination_address) {
    // write instruction
...
void ANVIL__code__debug__mark_code_section(ANVIL__workspace* workspace) {
    // write instruction
...
void ANVIL__code__push_register(ANVIL__workspace* workspace, ANVIL__flag_ID flag, ANVIL__register_ID source_register) {
    // write data to stack
    ANVIL__code__register_to_address(workspace, source_register, ANVIL__srt__constant__64, ANVIL__srt__stack__current_address);
...
void ANVIL__code__pop_register(ANVIL__workspace* workspace, ANVIL__flag_ID flag, ANVIL__register_ID destination_register) {
    ...
    ANVIL__code__address_to_register(workspace, ANVIL__srt__stack__current_address, ANVIL__srt__constant__64, destination_register);
...
void ANVIL__code__start(ANVIL__workspace* workspace, ANVIL__stack_size stack_size, ANVIL__offset jump_to) {
    // setup code marker
    ANVIL__code__debug__mark_code_section(workspace);
