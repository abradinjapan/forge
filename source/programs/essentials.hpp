...
void ESS__code__print_buffer(ANVIL__workspace* workspace, ESS__offsets* essential_offsets) {
    ...
    // get character
    ANVIL__code__address_to_register(workspace, ESS__rt__print_buffer__buffer_current, ANVIL__srt__constant__8, ESS__rt__print_buffer__character);
...
void ESS__code__retrieve_buffer__explicit(ANVIL__workspace* workspace, ESS__offsets* essential_offsets) {
    ...
    ANVIL__code__address_to_register(workspace, ESS__rt__retrieve_buffer__message_buffer_start, ESS__rt__retrieve_buffer__bit_size_of_buffer_length, ESS__rt__retrieve_buffer__buffer_length);
